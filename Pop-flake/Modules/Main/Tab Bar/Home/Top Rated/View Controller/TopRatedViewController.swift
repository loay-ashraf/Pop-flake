...
class TopRatedViewController: SFDynamicCollectionViewController<TopRatedViewModel> {

    required init?(coder: NSCoder) {
        super.init(coder: coder)
        collectionViewDataSource = CompactMovieDataSource()
        collectionViewDelegate = TopRatedDelegate(self)
