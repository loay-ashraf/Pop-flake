...
class ComingSoonViewController: SFDynamicCollectionViewController<ComingSoonViewModel> {

    required init?(coder: NSCoder) {
        super.init(coder: coder)
        collectionViewDataSource = FullMovieDataSource()
        collectionViewDelegate = ComingSoonDelegate(self)
